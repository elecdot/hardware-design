...
SAMPLER_GROUPS = (
    ...
    Group(
        ...
        (
            ...
            t("tb_jy901_sampler.dut.u_i2c_master_core.sda_in"),
            ...
            t("tb_jy901_sampler.dut.u_i2c_master_core.latched_read_len[7:0]"),
            t("tb_jy901_sampler.dut.u_i2c_master_core.last_read_byte"),
...
AXI_GROUPS = (
    ...
    Group(
        ...
        (
            ...
            t("tb_axi_i2c_jy901_top.dut.u_jy901_sampler.u_i2c_master_core.sda_in"),
            ...
            t("tb_axi_i2c_jy901_top.dut.u_jy901_sampler.u_i2c_master_core.latched_read_len[7:0]"),
            t("tb_axi_i2c_jy901_top.dut.u_jy901_sampler.u_i2c_master_core.last_read_byte"),
    ...
    Group(
        ...
        (
            ...
            t("tb_axi_i2c_jy901_top.slave.master_ack"),
...
BENCHES = {
    "sampler": Bench(
        ...
        views={
            ...
            "data": ("tb_control", "sampler_fsm", "i2c_core", "sample_data"),
    ...
    "axi": Bench(
        ...
        views={
            ...
            "data": ("tb_control", "axi_registers", "sampler_fsm", "i2c_core", "sample_data"),
