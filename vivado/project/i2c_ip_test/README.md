...
Open [i2c_ip_test.xpr](i2c_ip_test.xpr) in Vivado when a GUI project is needed. Prefer documenting reproducible build steps in [../README.md](../README.md) or future Tcl scripts.
