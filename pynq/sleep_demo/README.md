...
```bash
sudo env -u PYTHONPATH /opt/python3.6/bin/python3.6 integrated_demo.py --bitfile /home/xilinx/jupyter_notebooks/sleep_monitor/sleep_monitor.bit --samples 30
```
...
| DHT11 | `dht11_axi_0` |
| UART SpO2 | `axi_uart_spo2_0` |
| TFT LCD | `tft_lcd_spi_axi_0` |
